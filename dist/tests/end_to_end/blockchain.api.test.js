...
var MockElectrumClient = /** @class */ (function () {
    ...
    MockElectrumClient.prototype.blockchainEstimatefee = function (number) {
        return Promise.resolve(0.000201);
    };
    MockElectrumClient.prototype.blockchain_relayfee = function () {
...
describe('Blockchain methods', function () {
    ...
    it('return the estimated transaction fee per kilobyte for a transaction to be confirmed within a certain number of blocks', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, supertest_1.default(app).get('/blockchain/estimatefee')
    ...
    it('return the minimum fee a low-priority transaction must pay in order to be accepted to the daemon’s memory pool', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, supertest_1.default(app).get('/blockchain/relayfee')
                            .query(options({ blocks: 5 }))
                            .expect(200)
